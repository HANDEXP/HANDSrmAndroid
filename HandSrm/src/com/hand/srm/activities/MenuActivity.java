...
public class MenuActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTitle = (TextView) findViewById(R.id.main_head_title);
		SharedPreferences preferences = getSharedPreferences("userInfo",
				Context.MODE_APPEND);
		String description = preferences.getString("description", "John.Smith");
		// 设置
	...
	private void prepare() {
		...
		TabItem item1 = new TabItem("首页", // title
				R.drawable.tab_change_news, // icon
				new Intent(this, HomeActivity.class)); // intent

		TabItem item2 = new TabItem("订单", R.drawable.tab_change_navigation,
				new Intent(this, OrderTabActivity.class));

		TabItem item3 = new TabItem("财务", R.drawable.tab_change_share,
				new Intent(this, OrderTabActivity.class));

		TabItem item4 = new TabItem("发现", R.drawable.tab_change_finding,
				new Intent(this, OrderTabActivity.class));

		TabItem item5 = new TabItem("设置", R.drawable.tab_change_setting,
	...
	private void creatTab() {
		for (int i = 0; i < getTabItemCount(); i++) {
			...
			_textview.setCompoundDrawablesWithIntrinsicBounds(0, mItems.get(i)
					.getIcon(), 0, 0);
